...
const _descriptor_3 = new __compactRuntime.CompactTypeVector(3, _descriptor_1);
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.merkleLeftInputs) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named merkleLeftInputs');
    }
    if (typeof(witnesses_0.merkleRightInputs) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named merkleRightInputs');
    }
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(1n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(pText_0),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(6n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(adminCommit_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(7n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(eligRoot_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
  ...
  _merkleLeftInputs_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.merkleLeftInputs(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(Array.isArray(result_0) && result_0.length === 3 && result_0.every((t) => t.buffer instanceof ArrayBuffer && t.BYTES_PER_ELEMENT === 1 && t.length === 32))) {
  ...
  _merkleRightInputs_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.merkleRightInputs(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(Array.isArray(result_0) && result_0.length === 3 && result_0.every((t) => t.buffer instanceof ArrayBuffer && t.BYTES_PER_ELEMENT === 1 && t.length === 32))) {
  ...
  _castVote_0(context, partialProofData) {
    ...
    const commitment_0 = this._persistentHash_1(sk_0);
    const path_0 = this._merklePath_0(context, partialProofData);
    const leftInputs_0 = this._merkleLeftInputs_0(context, partialProofData);
    const rightInputs_0 = this._merkleRightInputs_0(context, partialProofData);
    const left0_0 = leftInputs_0[0];
    const right0_0 = rightInputs_0[0];
    __compactRuntime.assert(this._equal_0(left0_0, commitment_0)
                            &&
                            this._equal_1(right0_0, path_0[0])
                            ||
                            this._equal_2(left0_0, path_0[0])
                            &&
                            this._equal_3(right0_0, commitment_0),
                            'Invalid Merkle proof level 0');
    const node0_0 = this._persistentHash_0([left0_0, right0_0]);
    const left1_0 = leftInputs_0[1];
    const right1_0 = rightInputs_0[1];
    __compactRuntime.assert(this._equal_4(left1_0, node0_0)
                            &&
                            this._equal_5(right1_0, path_0[1])
                            ||
                            this._equal_6(left1_0, path_0[1])
                            &&
                            this._equal_7(right1_0, node0_0),
                            'Invalid Merkle proof level 1');
    const node1_0 = this._persistentHash_0([left1_0, right1_0]);
    const left2_0 = leftInputs_0[2];
    const right2_0 = rightInputs_0[2];
    __compactRuntime.assert(this._equal_8(left2_0, node1_0)
                            &&
                            this._equal_9(right2_0, path_0[2])
                            ||
                            this._equal_10(left2_0, path_0[2])
                            &&
                            this._equal_11(right2_0, node1_0),
                            'Invalid Merkle proof level 2');
    const node2_0 = this._persistentHash_0([left2_0, right2_0]);
    __compactRuntime.assert(this._equal_12(node2_0,
                                           _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                     ...
                                                                                                     [
                                                                                                      ...
                                                                                                      { popeq: { cached: false,
                                                                                                                 result: undefined } }]).value)),
                            'Voter credential is not in the eligibility set');
  ...
  _closeVoting_0(context, partialProofData) {
    ...
    __compactRuntime.assert(this._equal_13(this._persistentHash_1(adminSk_0),
                                           _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                     partialProofData,
                                                                                                     [
                                                                                                      { dup: { n: 0 } },
...
const _dummyContract = new Contract({
  ...
  merkleLeftInputs: (...args) => undefined,
  merkleRightInputs: (...args) => undefined
});
